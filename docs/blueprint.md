...
GEMINI_MODEL_ID="gemini-3.6-flash"            # Gemini（母ちゃん）
...
| ECS Cluster | `okamo-channel` |
| Task Definition | `okamo-channel-daily:9` (1vCPU / 4GB, FARGATE。`CLAUDE_MODEL_ID=claude-sonnet-5`, `OPEN_AI_MODEL_ID=gpt-5.4`) |
